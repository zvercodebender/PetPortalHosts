...
chmod +x xl
./xl apply --xl-deploy-url=https://xlr.rbroker.linkpc.net --xl-deploy-username=$XLD_USER --xl-release-password=$XLD_PASSWD --file petportalhosts.yaml --values version=$VERSION
